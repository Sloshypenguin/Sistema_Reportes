...
class DashboardService {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para dashboard: $jsonResponse');
          return null;
        }
      } else {
        print('Error HTTP al obtener resumen de dashboard: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar resumen de dashboard: ${response.statusCode}");
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para reportes por mes: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener reportes por mes: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar reportes por mes: ${response.statusCode}");
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para reportes por servicio: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener reportes por servicio: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar reportes por servicio: ${response.statusCode}");
      }
    } catch (e) {
  ...
  Future<List<ReportePorMunicipio>> obtenerReportesPorMunicipio() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/Dashboard/ReportesPorMunicipio');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para reportes por municipio: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener reportes por municipio: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar reportes por municipio: ${response.statusCode}");
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para reportes por estado: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener reportes por estado: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar reportes por estado: ${response.statusCode}");
      }
    } catch (e) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para top usuarios: $jsonResponse');
          return [];
        }
      } else {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          print('Estructura de respuesta inesperada para resumen de usuarios: $jsonResponse');
          return null;
        }
      } else {
        print('Error HTTP al obtener resumen de usuarios: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar resumen de usuarios: ${response.statusCode}");
      }
    } catch (e) {
  ...
  Future<List<ServicioMasReportado>> obtenerServiciosMasReportados() async {
    ...
    final url = Uri.parse('${ApiConfig.baseUrl}/Dashboard/ServiciosMasReportados');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          final List<dynamic> data = jsonResponse['data'];
          return data.map((item) => ServicioMasReportado.fromJson(item)).toList();
        } else {
          print('Estructura de respuesta inesperada para servicios más reportados: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener servicios más reportados: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar servicios más reportados: ${response.statusCode}");
      }
    } catch (e) {
  ...
  Future<List<ResumenEstadoPorServicio>> obtenerResumenEstadoPorServicio() async {
    final hasConnection = await _connectivityService.hasConnection();
    if (!hasConnection) {
      throw Exception("Sin conexión a internet");
    }

    final url = Uri.parse('${ApiConfig.baseUrl}/Dashboard/ResumenEstadoPorServicio');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonResponse.containsKey('data') && 
          ...
          final List<dynamic> data = jsonResponse['data'];
          return data.map((item) => ResumenEstadoPorServicio.fromJson(item)).toList();
        } else {
          print('Estructura de respuesta inesperada para resumen de estado por servicio: $jsonResponse');
          return [];
        }
      } else {
        print('Error HTTP al obtener resumen de estado por servicio: ${response.statusCode}');
        print('Error body: ${response.body}');
        throw Exception("Error al cargar resumen de estado por servicio: ${response.statusCode}");
      }
    } catch (e) {
